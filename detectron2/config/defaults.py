...
_C.MODEL.FCOS.SCALE_PER_LEVEL = [64, 128,256, 512]
_C.MODEL.FCOS.FPN_STRIDE = [8,16,32,64,128]
_C.MODEL.FCOS.CENTERNESS_ON_CLS = True
...
_C.MODEL.FCOS.CLS_TO_BOX = False
...
_C.MODEL.IRNET.CLS_FEATURE = "res5"
_C.MODEL.IRNET.THRESHOLD = 0.7
_C.MODEL.IRNET.FOCAL_LOSS_GAMMA = 2.0
_C.MODEL.IRNET.FOCAL_LOSS_ALPHA = 0.25
_C.MODEL.IRNET.FORE_GROUND_THRESHOLD = 0.3
_C.MODEL.IRNET.BACK_GROUND_THRESHOLD = 0.05
